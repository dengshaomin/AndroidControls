 ...
 */
public abstract class GCLinearlayout extends LinearLayout implements GCUIInterface {
    ...
    public GCLinearlayout(Context context) {
        this(context, null);
    }

    public GCLinearlayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GCLinearlayout(Context context, AttributeSet attrs, int defStyleAttr) {
