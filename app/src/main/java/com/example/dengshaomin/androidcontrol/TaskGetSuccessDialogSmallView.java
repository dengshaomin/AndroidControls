 ...
 */
public class TaskGetSuccessDialogSmallView extends GCLinearlayout {
    private List<Reward> rewards;
    private RelativeLayout true_view;
    private LinearLayout container;

    public TaskGetSuccessDialogSmallView(Context context) {
        super(context);
    }

    public TaskGetSuccessDialogSmallView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TaskGetSuccessDialogSmallView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @Override
    public int setContentLayout() {
        return R.layout.task_getsuccess_dialogsmallview;
    }
